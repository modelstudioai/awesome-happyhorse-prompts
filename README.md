...
[HappyHorse 1.0](https://bailian.console.aliyun.com/cn-beijing?source_channel=K7mP9wR2vA&tab=model#/efm/model_experience_center/vision/videoGenerate) 是一款基于原生多模态架构的新一代 AI 视频生成模型，支持音视频协同生成。产品深度适配广告营销、电商展示、短剧制作与社交媒体创意等内容生产场景，提供从**智能生成**到**精细编辑**的一体化创作工作流。
...
| happyhorse-1.0-t2v | 输入文本提示词生成物理真实、运动流畅的视频内容。 | 文字 → 视频 | - |
...
**开发文档：** [百炼控制台](https://bailian.console.aliyun.com/cn-beijing?source_channel=K7mP9wR2vA&tab=model#/efm/model_experience_center/vision/videoGenerate)
